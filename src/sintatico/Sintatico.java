...
public class Sintatico {
    ...
    public static void main(String[] args) {
        ...
        estados.put(50, new Estado(Tipo.W, 50, new Path[]{}, new Path[]{}));
        estados.put(51, new Estado(Tipo.W, 51, new Path[]{}, new Path[]{}));
        ...
        estados.put(54, new Estado(Tipo.FA_, 54, new Path[]{}, new Path[]{}));
        estados.put(55, new Estado(Tipo.FA_, 55, new Path[]{}, new Path[]{}));
        estados.put(56, new Estado(Tipo.IS, 56, new Path[]{new Path(Tipo.SMB_CPA, 78)}, new Path[]{}));
        estados.put(57, new Estado(Tipo.CN, 57, new Path[]{}, new Path[]{}));
        ...
        estados.put(60, new Estado(Tipo.SE, 60, new Path[]{}, new Path[]{}));
        ...
        estados.put(62, new Estado(Tipo.SE_, 62, new Path[]{}, new Path[]{}));
        estados.put(63, new Estado(Tipo.A, 63, new Path[]{}, new Path[]{}));
        estados.put(64, new Estado(Tipo.A, 64, new Path[]{}, new Path[]{}));
        estados.put(65, new Estado(Tipo.A, 65, new Path[]{}, new Path[]{}));
        estados.put(66, new Estado(Tipo.TE, 66, new Path[]{}, new Path[]{}));
        ...
        estados.put(68, new Estado(Tipo.TE_, 68, new Path[]{}, new Path[]{}));
        estados.put(69, new Estado(Tipo.M, 69, new Path[]{}, new Path[]{}));
        estados.put(70, new Estado(Tipo.M, 70, new Path[]{}, new Path[]{}));
        estados.put(71, new Estado(Tipo.M, 71, new Path[]{}, new Path[]{}));
        estados.put(72, new Estado(Tipo.FA, 72, new Path[]{}, new Path[]{}));
        estados.put(73, new Estado(Tipo.F, 73, new Path[]{}, new Path[]{}));
        estados.put(74, new Estado(Tipo.F, 74, new Path[]{}, new Path[]{}));
        ...
        estados.put(76, new Estado(Tipo.CT, 76, new Path[]{}, new Path[]{}));
        estados.put(77, new Estado(Tipo.CT, 77, new Path[]{}, new Path[]{}));
        estados.put(78, new Estado(Tipo.IS, 78, new Path[]{new Path(Tipo.SMB_OBC, 93)}, new Path[]{}));
        estados.put(79, new Estado(Tipo.E, 79, new Path[]{}, new Path[]{}));
        ...
        estados.put(81, new Estado(Tipo.E_, 81, new Path[]{}, new Path[]{}));
        estados.put(82, new Estado(Tipo.R, 82, new Path[]{}, new Path[]{}));
        estados.put(83, new Estado(Tipo.R, 83, new Path[]{}, new Path[]{}));
        estados.put(84, new Estado(Tipo.R, 84, new Path[]{}, new Path[]{}));
        estados.put(85, new Estado(Tipo.R, 85, new Path[]{}, new Path[]{}));
        estados.put(86, new Estado(Tipo.R, 86, new Path[]{}, new Path[]{}));
        estados.put(87, new Estado(Tipo.R, 87, new Path[]{}, new Path[]{}));
        estados.put(88, new Estado(Tipo.WHS, 88, new Path[]{}, new Path[]{}));
        estados.put(89, new Estado(Tipo.SP, 89, new Path[]{}, new Path[]{}));
        ...
        estados.put(94, new Estado(Tipo.E_, 94, new Path[]{}, new Path[]{}));
        estados.put(95, new Estado(Tipo.SE_, 95, new Path[]{}, new Path[]{}));
        estados.put(96, new Estado(Tipo.TE_, 96, new Path[]{}, new Path[]{}));
        estados.put(97, new Estado(Tipo.F, 97, new Path[]{}, new Path[]{}));
        ...
        estados.put(100, new Estado(Tipo.IS, 100, new Path[]{}, new Path[]{}));
        estados.put(101, new Estado(Tipo.IS_, 101, new Path[]{}, new Path[]{}));
        estados.put(102, new Estado(Tipo.IS_, 102, new Path[]{}, new Path[]{}));
        ...
        estados.put(105, new Estado(Tipo.IS_, 105, new Path[]{}, new Path[]{}));
